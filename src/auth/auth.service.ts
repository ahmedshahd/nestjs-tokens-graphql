...
import { SigninResponse, SignupResponse } from 'src/graphql';

@Injectable()
export class AuthService {
  constructor(private prisma: PrismaService, private jwtService: JwtService) {}
  async signupLocal(dto: AuthDto): Promise<SignupResponse> {
  ...
  async signinLocal(dto: AuthDto): Promise<SigninResponse> {
